...
class CategoriesListForRestaurantWidget extends StatelessWidget {
  double marginLeft;
  Category category;
  String city_id;
  String restaurant_id;
  String city;
  CategoriesListForRestaurantWidget(
      {Key key,
      this.marginLeft,
      this.category,
      this.city_id,
      ...
      onTap: () {
        Navigator.of(context).pushNamed('/Product',
            arguments: RouteArgument(
                id: restaurant_id, category_id: category.id, city_id: city_id,city: city));
      },
      child: Padding(
