                      ...
                      children: <Widget>[
                        ...
                        new TextFormField(
                          ...
                          validator: (input) => input.trim().length < 3
                              ...
                              : null,
                          onSaved: (input){
                                 widget.user.phone = input;
                                 currentUser.value.phone = input;
                                 currentUser.value.mobile = input;
print("Phone No.::::::::::::::>>>>>>>>>>>>>>>>>>>>>>>>>>>>> " +widget.user.phone);
                          },
                        ),
                        new TextFormField(
                          style: TextStyle(color: Theme.of(context).hintColor),
                          ...
                          print("Address .::::::::::::::>>>>>>>>>>>>>>>>>>>>>>>>>>>>> " +widget.user.address);
                          currentUser.value.address = input;
                          },
                        ),
                        new TextFormField(
                          style: TextStyle(color: Theme.of(context).hintColor),
                          ...
                          validator: (input) => input.trim().length < 3
                              ...
                              : null,
                          onSaved: (input){
                                  widget.user.bio = input;
                                  print("Bio Details::::::::::::::>>>>>>>>>>>>>>>>>>>>>>>>>>>>> " +widget.user.bio);
                                currentUser.value.bio = input
                                  ;
                          },
                        ),
                      ],
