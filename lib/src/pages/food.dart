...
//    print("Food details :- " + _con.food.toString());
  }
                      ...
                      slivers: <Widget>[
                        SliverAppBar(
                          ...
                          flexibleSpace: FlexibleSpaceBar(
                            ...
                            background: _con.food.image == null
                                ? Container()
                                : Image.network(
                                    _con.food.image.url,
                                    loadingBuilder:
                                  ...
                                  children: <Widget>[
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                          color: _con.food.deliverable == true
                                              ? Colors.green
                                              : Colors.orange,
                                          borderRadius:
                                              BorderRadius.circular(24)),
                                      child: _con.food.deliverable == true
                                          ? Text(
