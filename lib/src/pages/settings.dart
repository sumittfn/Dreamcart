import 'package:Dreamcart/src/elements/PermissionDeniedWidget.dart';
...
class SettingsWidget extends StatefulWidget {
 ...
 String cityName;
   ...
   SettingsWidget({Key key,this.change, this.parentScaffoldKey,this.cityName}) : super(key: key);
  @override
...
class _SettingsWidgetState extends StateMVC<SettingsWidget> {
  ...
  initState() {
    // print(
    //     "Current User Data ::::::::::::::>>>>>>>>> " + repository.currentUser.toString());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: repository.currentUser.value.id == null
                        ...
                        children: <Widget>[
                          Expanded(
                            child: Column(
                              children: <Widget>[
                                Text(
                                  repository.currentUser.value.name,
                                  textAlign: TextAlign.left,
                                  style: Theme.of(context).textTheme.display2,
                                ),
                                Text(
                                  repository.currentUser.value.email,
                          ...
                          SizedBox(
                              ...
                              child: InkWell(
                                ...
                                child: repository.currentUser.value.image == null
                                    ? Container(
                                        height: 40.0,
                                        width: 40.0,
                                    ...
                                    : CircleAvatar(
                                        backgroundImage: NetworkImage(
                                          repository.currentUser.value.image.thumb,
                                        ),
                                      ),
                              )),
                        ],
                      ...
                      child: ListView(
                        ...
                        children: <Widget>[
                          ...
                          ListTile(
                            ...
                            trailing: Text(
                              repository.currentUser.value.phone == null
                                  ? ""
                                  : repository.currentUser.value.phone,
                              style: TextStyle(
                                  color: Theme.of(context).focusColor),
                            ),
                          ),
                          ListTile(
                            ...
                            trailing: Text(
                              Helper.limitString(
                                  repository.currentUser.value.address == null
                                      ? ""
                                      : repository.currentUser.value.address),
                          ...
                          ListTile(
                            ...
                            trailing: Text(
                              Helper.limitString(repository.currentUser.value.bio == null
                                  ? ""
                                  : repository.currentUser.value.bio),
                              overflow: TextOverflow.fade,
                              softWrap: false,
                              style: TextStyle(
                                  color: Theme.of(context).focusColor),
                          ...
                          ListTile(
                            onTap: () {
                              Navigator.of(context)
                                  .pushNamed('/DeliveryAddresses',arguments: RouteArgument(city: widget.cityName));
                            },
                            dense: true,
                            title: Row(
                              children: <Widget>[
