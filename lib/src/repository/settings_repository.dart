...
Future<Setting> initSettings() async {
 ...
 Future<dynamic> setCurrentLocation() async {
  ...
  //  SharedPreferences prefs = await SharedPreferences.getInstance();
   ...
   double latitude = 123456.12;
   double longitude = 654321.89;
   String _addressName =currentUser.value.address;
...
//  await prefs.clear();
  if (prefs.containsKey('delivery_address')) {
    ...
    deliveryAddress.value = Address.fromJSON({'address':currentUser.value.address,});
