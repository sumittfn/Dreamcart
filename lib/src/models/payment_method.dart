  ...
  PaymentMethodList() {
    this._paymentsList = [
      new PaymentMethod(
          "Pay Online",
          S.current.visa_card,
          S.current.click_to_pay_with_your_visa_card,
          "/Checkout",
          "assets/img/visacard.png",
          isDefault: true),
//      new PaymentMethod(
//          "mastercard",
//          S.current.mastercard,
//          S.current.click_to_pay_with_your_mastercard,
//          "/Checkout",
//          "assets/img/mastercard.png"),
//      new PaymentMethod(
//          "paypal",
//          S.current.paypal,
//          S.current.click_to_pay_with_your_paypal_account,
//          "/PayPal",
//          "assets/img/paypal.png"),
    ...
    this._cashList = [
      new PaymentMethod(
          ...
          S.current.click_to_pay_cash_on_delivery,
          "/CashOnDelivery",
          "assets/img/cash.png"),
    ];
    this._pickupList = [
      new PaymentMethod(
          "Take Away",
          S.current.pay_on_pickup,
          S.current.click_to_pay_on_pickup,
          "/PayOnPickup",
